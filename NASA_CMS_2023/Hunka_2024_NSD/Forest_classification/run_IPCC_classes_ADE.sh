...
FOREST_COVER_LOSSYEAR="input/Hansen_GFC-2022-v1.10_lossyear_${tile}.tif"
BOREAL_AGE="input/${tile}_BOREAL_AGE.tif"
PLANTATIONS="input/${tile}_plantation_type_oilpalm_woodfiber_other.tif"
...
EcoCont="input/${tile}_EcoCont.tif"
